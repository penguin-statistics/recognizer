...
namespace penguin {  // result
  ...
  const std::map<int, DroptypeFlags> HSV_H2Droptype{
      {51, DROPTYPE_LMB},          {201, DROPTYPE_FIRST},
      {0, DROPTYPE_NORMAL_DROP},   {360, DROPTYPE_NORMAL_DROP},
      {25, DROPTYPE_SPECIAL_DROP}, {63, DROPTYPE_EXTRA_DROP},
  ...
  public:
    ...
    Widget_Stage(Widget* const parent_widget) : Widget("stage", parent_widget) {}
  ...
  public:
    ...
    Widget_Stars(Widget* const parent_widget) : Widget("3stars", parent_widget) {}
  ...
  public:
    ...
    Widget_DroptypeLine(Widget* const parent_widget) : Widget(parent_widget) {}
  ...
  public:
    ...
    Widget_DroptypeText(Widget* const parent_widget) : Widget(parent_widget) {}
  ...
  public:
    ...
    Widget_Droptype(const cv::Mat& img, const std::string& label,
  ...
  public:
    ...
    Widget_DropArea(Widget* const parent_widget) : Widget(parent_widget) {}
    Widget_DropArea(const cv::Mat& img, const std::string& stage,
      Widget* const parent_widget = nullptr)
      : Widget(img, parent_widget) {}
  ...
  private:
    ...
    void _get_drops(std::string stage) {
      ...
      for (const auto& droptype_range : sp) {
        ...
        if (const auto type = droptype.droptype(); type == DROPTYPE_UNDEFINED ||
          ...
          _drop_list.emplace_back(Drop(Widget_Item(FURNI_1, label, this), type));
        }
          ...
          for (int i = 0; i < items_count; i++) {
            ...
            auto range = cv::Range(droptype_range.start + length * i,
  ...
  public:
    Result() = default;
    Result(const cv::Mat& img) : Widget(img) {}
    Result& analyze() {
      _get_baseline_v();
      _get_result_label();
      _get_stage();
  ...
  private:
    ...
    void _get_result_label() {
      ...
      auto result_img = _img(cv::Range(bv.y + bv.height / 2, bv.y + bv.height),
        cv::Range(0, bv.x - 5));
    ...
    void _get_drop_area() {
      ...
      const auto& bv = _baseline_v;
      auto drop_area_img =
        _img(cv::Range(bv.y + bv.height * DROP_AREA_Y_PROP, bv.y + bv.height),
